...
Το project χρησιμοποιεί το **Google Gemini 2.0 Flash** για ταχύτατη ανάλυση εγγράφων και το **Streamlit** για το περιβάλλον χρήστη.

## 🚀 Δυνατότητες

* **Native PDF Analysis:** Διαβάζει το αρχείο PDF αυτούσιο (όχι ως απλό κείμενο), κατανοώντας πίνακες, μορφοποίηση και δομή.
* **Gemini 2.0 Flash:** Χρησιμοποιεί το πιο γρήγορο μοντέλο της Google με τεράστιο context window.
