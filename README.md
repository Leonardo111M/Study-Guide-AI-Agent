...
Το project χρησιμοποιεί το **Google Gemini 2.5 PRO** για προηγμένη ανάλυση εγγράφων και το **Streamlit** για το περιβάλλον χρήστη.

## 🚀 Δυνατότητες

* **Native PDF Analysis:** Διαβάζει το αρχείο PDF αυτούσιο (όχι ως απλό κείμενο), κατανοώντας πίνακες, μορφοποίηση και δομή.
* **Gemini 2.5 PRO:** Χρησιμοποιεί το πιο ισχυρό μοντέλο της Google με τεράστιο context window.
